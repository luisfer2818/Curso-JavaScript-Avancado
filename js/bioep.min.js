window.bioEp = {
    ...
    checkCookie: function() { if (0 >= this.cookieExp) { if (this.showOncePerSession && "true" == this.cookieManager.get("bioep_shown_session")) return !0;
            this.cookieManager.erase("bioep_shown"); return !1 } return "true" == this.cookieManager.get("bioep_shown") ? !0 : !1 },
    addCSS: function() {
    ...
    hidePopup: function() { this.bgEl.style.display = "none";
    ...
    addEvent: function(a, b, d) { a.addEventListener ? a.addEventListener(b, d, !1) : a.attachEvent && a.attachEvent("on" + b, d) },
    loadEvents: function() {
        ...
        this.addEvent(this.closeBtnEl, "click", function() { bioEp.hidePopup() });
        this.addEvent(window, "resize", function() { bioEp.scalePopup() })
    },
    ...
    init: function(a) { "undefined" !== typeof a && this.setOptions(a);
        this.addCSS();
        this.domReady(function() { bioEp.checkCookie() || (bioEp.addPopup(), setTimeout(function() { bioEp.loadEvents();
                bioEp.showOnDelay && bioEp.showPopup() }, 1E3 * bioEp.delay)) }) }
};