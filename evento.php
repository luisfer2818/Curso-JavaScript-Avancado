<?php
	session_start();
	include_once("conexaoEvento.php");
...
<html lang="pt-br">
	...
	<body>
		...
		<div class="container">
			...
			<button type="button" class="btn btn-primary" onClick="history.go(-1)"><span class="glyphicon glyphicon-share-alt"></span> Voltar </button>
			<hr>
			<?php
